class SimpleChartStreaming {
    ...
    private renderer = new Renderer("#statusCode", "#responseBody");
    private openApiCommunication = new OpenApiCommunication(this.BASE_URL, this.ACCESS_TOKEN, this.renderer);
    ...
    private processSnapshot = (response: OpenApiSubscriptionResponse) =>{
    ...
    private receiveMessages = (messages: OpenApiStreamingResponse[]) => {
    ...
    private processMessages = (messages: OpenApiStreamingResponse[]) =>{
    ...
    public getHistoricalSamples = () =>{
        ...
        this.openApiCommunication.callOpenApi("GET", url, {}, function (chartData:ChartData) {
