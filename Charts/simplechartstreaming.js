...
(function (OpenApiChartDemo) {
    ...
    var SimpleChartStreaming = (function () {
        function SimpleChartStreaming() {
            ...
            this.renderer = new OpenApi.Renderer("#statusCode", "#responseBody");
            this.openApiCommunication = new OpenApi.OpenApiCommunication(this.BASE_URL, this.ACCESS_TOKEN, this.renderer);
            this.chart = new OpenApiChartDemo.HighChart();
            ...
            this.getHistoricalSamples = function () {
                ...
                _this.openApiCommunication.callOpenApi("GET", url, {}, function (chartData) {
                    ...
                    if ((null == chartData.DataVersion) || (typeof chartData.DataVersion == 'undefined') || (chartData.DataVersion === _this.dataVersion)) {
                        _this.addChartData(chartData);
                        _this.storeEarliestSampleTime(chartData);
                        _this.chart.redraw();
                    }
                    else {
                        _this.restart();
    ...
    OpenApiChartDemo.SimpleChartStreaming = SimpleChartStreaming;
